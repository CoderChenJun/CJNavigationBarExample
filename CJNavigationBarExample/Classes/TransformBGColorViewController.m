//
//  TransformBGColorViewController.m
...
#import "TransformBGColorViewController.h"
#import "UINavigationBar+CJ.h"

#define NAVBAR_CHANGE_POINT 50

@interface TransformBGColorViewController ()<UITableViewDataSource,UITableViewDelegate>
...
@implementation TransformBGColorViewController
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView
{
    ...
    if (offsetY > NAVBAR_CHANGE_POINT) {
        ...
        [self.navigationController.navigationBar cj_setBackgroundColor:[color colorWithAlphaComponent:0]];
    }
}
